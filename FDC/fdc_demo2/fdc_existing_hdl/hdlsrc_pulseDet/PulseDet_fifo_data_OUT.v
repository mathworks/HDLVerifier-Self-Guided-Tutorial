...
// -------------------------------------------------------------
// 
// File Name: custom_hdl_prj\hdlsrc\pulse_detector_ipcore\PulseDet_fifo_data_OUT.v
...
module PulseDet_fifo_data_OUT
  ...
  PulseDet_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                     ...
                                     u_PulseDet_fifo_data_OUT_classic_ram_generic (.clk(clk),
                                                                                   .enb(enb),
                                                                                   .wr_din(In),
                                                                                   .wr_addr(w_waddr),
                                                                                   .wr_en(w_we),  // ufix1
...
endmodule  // PulseDet_fifo_data_OUT
