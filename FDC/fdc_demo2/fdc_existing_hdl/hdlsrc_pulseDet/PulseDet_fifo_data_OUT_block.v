...
// -------------------------------------------------------------
// 
// File Name: custom_hdl_prj\hdlsrc\pulse_detector_ipcore\PulseDet_fifo_data_OUT_block.v
...
// -------------------------------------------------------------
// 
// Module: PulseDet_fifo_data_OUT_block
// Source Path: PulseDet/PulseDet_axi4_stream_master/PulseDet_fifo_data_OUT
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module PulseDet_fifo_data_OUT_block
  ...
  PulseDet_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                       .DataWidth(16)
                                       )
                                     u_PulseDet_fifo_data_OUT_classic_ram (.clk(clk),
                                                                           .enb(enb),
                                                                           .wr_din(In),
                                                                           .wr_addr(w_waddr),
                                                                           .wr_en(w_we),  // ufix1
...
endmodule  // PulseDet_fifo_data_OUT_block
