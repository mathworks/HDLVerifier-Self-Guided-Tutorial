...
// -------------------------------------------------------------
// 
// File Name: custom_hdl_prj\hdlsrc\pulse_detector_ipcore\PulseDet_src_Filter.v
...
// -------------------------------------------------------------
// 
// Module: PulseDet_src_Filter
// Source Path: pulse_detector_ipcore/Pulse Detector IP/Pulse Detector/Matched Filter/Discrete FIR Filter/Filter
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module PulseDet_src_Filter
  ...
  PulseDet_src_FilterCoef u_CoefTableP_1 (.CoefOutP_0(CoefOutP_0),  // sfix19_En23
  ...
  PulseDet_src_subFilter u_subFilter_1_reP (.clk(clk),
                                            .reset(reset),
                                            .enb(enb),
  ...
  PulseDet_src_FilterCoef_block1 u_CoefTableI_1 (.CoefOutI_0(CoefOutI_0),  // sfix19_En23
  ...
  PulseDet_src_subFilter u_subFilter_1_im (.clk(clk),
                                           .reset(reset),
                                           .enb(enb),
  ...
  PulseDet_src_FilterCoef_block u_CoefTableS_1 (.CoefOutS_0(CoefOutS_0),  // sfix19_En23
  ...
  PulseDet_src_subFilter u_subFilter_1_reS (.clk(clk),
                                            .reset(reset),
                                            .enb(enb),
