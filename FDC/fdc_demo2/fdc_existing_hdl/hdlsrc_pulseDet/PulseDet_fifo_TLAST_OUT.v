...
// -------------------------------------------------------------
// 
// File Name: custom_hdl_prj\hdlsrc\pulse_detector_ipcore\PulseDet_fifo_TLAST_OUT.v
...
// -------------------------------------------------------------
// 
// Module: PulseDet_fifo_TLAST_OUT
// Source Path: PulseDet/PulseDet_axi4_stream_master/PulseDet_fifo_TLAST_OUT
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module PulseDet_fifo_TLAST_OUT
  ...
  PulseDet_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                         .DataWidth(1)
                                         )
                                       u_PulseDet_fifo_TLAST_OUT_classic_ram_singlebit (.clk(clk),
                                                                                        .enb(enb),
                                                                                        .wr_din(In),  // ufix1
                                                                                        .wr_addr(w_waddr),
                                                                                        .wr_en(w_we),  // ufix1
...
endmodule  // PulseDet_fifo_TLAST_OUT
