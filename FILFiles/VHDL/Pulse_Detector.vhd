...
-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\VHDL\pulse_detector_v4\Pulse_Detector.vhd
...
BEGIN
  -- Valid should be connected to the tapped delay in Peak Finder
  ...
  u_Compute_Power : Compute_Power
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              data_in_re => filter_out_re,  -- sfix40_En37
